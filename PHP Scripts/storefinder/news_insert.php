        ...
        <div class="panel-body">
              <div class="row">
                ...
                <div class="col-md-7">
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="News URL" name="news_url" required>
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Photo Url" name="photo_url">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <textarea type="text" class="form-control" placeholder="News Content" rows="10" name="news_content" id="details"></textarea>
                      </div>
