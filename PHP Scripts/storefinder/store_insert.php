              ...
              <div class="row">
                <div class="col-md-7">
                  ...
                  <form action="" method="POST">
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Address" name="store_address" required>
                      </div>
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Phone No" required name="phone_no">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="SMS No" required name="sms_no">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Website" required name="website">
                      </div>
                      ...
                      <div class="input-group" style="width:100%;" >
                        <select class="form-control" style="width:100%;" name="featured">
                          ...
                          <option value="1">Store Featured</option>
                          <option value="0">Store Not Featured</option>
                        </select>
                      </div>
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <textarea type="text" class="form-control" placeholder="Description" rows="10" name="store_desc" id="details"></textarea>
                      </div>
