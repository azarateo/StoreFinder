              ...
              <div class="row">
                <div class="col-md-7">
                  ...
                  <form action="" method="POST">
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Address" name="store_address" required value="<?php echo $store->store_address; ?>">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Email" name="email" required value="<?php echo $store->email; ?>">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Phone No" required name="phone_no" value="<?php echo $store->phone_no; ?>">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="SMS No" required name="sms_no" value="<?php echo $store->sms_no; ?>">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Website" required name="website" value="<?php echo $store->website; ?>">
                      </div>
