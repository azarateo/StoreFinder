...
@interface FavoritesViewController () <MGListViewDelegate>
...
-(void) getFavorites {
    ...
    NSArray* array = [CoreDataController getFavoriteStores];
    ...
    for(int x = 0; x < array.count; x++) {
        ...
        Store* store = [CoreDataController getStoreByStoreId:fave.store_id];
    ...
    listViewMain.arrayData = tempArray;
